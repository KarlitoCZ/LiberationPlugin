...
public sealed class SpawnHandling
{
    ...
    public bool SpawnWave()
    {
        ...
        Announcer.Message(
            $".g2 .g5 $PITCH_0.97 ATTENTIONALLPERSONNEL. $PITCH_1 .g2 BREACH .g4 DETECTED IN ENTRANCE ZONE. $PITCH_0.93 INDENTIFIED {chosenPlayers.Count} UNAUTHORIZED $PITCH_1 L A F PERSONNEL $PITCH_1 .g1 . LETHAL FORCE AUTHORIZED",
