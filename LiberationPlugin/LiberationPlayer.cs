...
public class LiberatorRank
{
    ...
    public static readonly LiberatorRank Awakened = new (1, 3,"Awakened", new List<ItemType>
    {
        ItemType.Adrenaline,
        ItemType.Medkit,
    ...
    public static readonly LiberatorRank Freeborn = new (2, 1,"Freeborn", new List<ItemType>
    {
        ItemType.Adrenaline,
        ItemType.Medkit,
        ItemType.ArmorCombat,
    ...
    public static readonly LiberatorRank Oathkeeper = new (3, 1,"Oathkeeper", new List<ItemType>()
    {
        ItemType.Adrenaline,
        ItemType.ArmorCombat,
        ItemType.SCP500,
